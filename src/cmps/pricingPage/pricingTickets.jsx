...
import "../../assets/styles/cmps/pricingPage/pricingTickets.css";

export default function PricingTickets() {
    return (
        <div className="flex flex-wrap items-baseline justify-center gap-6">
            <div className="w-72 text-center text-gray-800/80 border border-gray-200 p-6 pb-16 rounded-lg basic-ticket">
                ...
                <button type="button" className="cursor-pointer bg-indigo-500 text-sm w-full py-2 rounded text-white font-medium mt-7 hover:bg-indigo-600 transition-all">
                    Get Started
                </button>
            </div>
        
            <div className="w-72 relative text-center text-white border border-gray-500/30 p-6 pb-14 rounded-lg pro-ticket">
                ...
                <button type="button" className="cursor-pointer bg-white text-sm w-full py-2 rounded text-indigo-500 font-medium mt-7 hover:bg-gray-300 transition-all">
                    Get Started
                </button>
            </div>
        
            <div className="w-72 text-center text-gray-800/80 border border-gray-200 p-6 rounded-lg enterprise-ticket">
